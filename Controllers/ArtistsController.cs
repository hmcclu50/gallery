...
namespace farris_art_gallery
{
    public class ArtistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Biography,WebsiteUrl")] Artist artist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Biography,WebsiteUrl")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
